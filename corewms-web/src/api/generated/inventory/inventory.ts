...
export const postApiInventoryHandlingUnitsQuality = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<void>(
      {url: `/api/inventory/handling-units/quality`, method: 'POST',
...
export const getPostApiInventoryHandlingUnitsQualityMutationKey = () => ['postApiInventoryHandlingUnitsQuality'] as const;

export const getPostApiInventoryHandlingUnitsQualityMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiInventoryHandlingUnitsQuality>>, TError,PostApiInventoryHandlingUnitsQualityMutationVariables, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiInventoryHandlingUnitsQuality>>, TError,PostApiInventoryHandlingUnitsQualityMutationVariables, TContext> => {

const mutationKey = getPostApiInventoryHandlingUnitsQualityMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiInventoryHandlingUnitsQuality>>, PostApiInventoryHandlingUnitsQualityMutationVariables> = (props) => {
          const {data} = props ?? {};

          return  postApiInventoryHandlingUnitsQuality(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiInventoryHandlingUnitsQualityMutationResult = NonNullable<Awaited<ReturnType<typeof postApiInventoryHandlingUnitsQuality>>>
    export type PostApiInventoryHandlingUnitsQualityMutationBody = ChangeQualityCommand
    export type PostApiInventoryHandlingUnitsQualityMutationError = unknown
    export type PostApiInventoryHandlingUnitsQualityMutationVariables = {data: ChangeQualityCommand}

    export const usePostApiInventoryHandlingUnitsQuality = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiInventoryHandlingUnitsQuality>>, TError,PostApiInventoryHandlingUnitsQualityMutationVariables, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof postApiInventoryHandlingUnitsQuality>>,
        TError,
        PostApiInventoryHandlingUnitsQualityMutationVariables,
        TContext
      > => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export const getApiInventoryPutawaySuggestionsOrderId = (
    orderId: string,
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
) => {
      ...
      return customInstance<void>(
      {url: `/api/inventory/putaway/suggestions/${orderId}`, method: 'GET', signal
    },
      options);
    }
...
export const getGetApiInventoryPutawaySuggestionsOrderIdQueryKey = (orderId: string,) => {
    return [
    `/api/inventory/putaway/suggestions/${orderId}`
    ] as const;
    }


export const getGetApiInventoryPutawaySuggestionsOrderIdQueryOptions = <TData = Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>, TError = unknown>(orderId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetApiInventoryPutawaySuggestionsOrderIdQueryKey(orderId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>> = ({ signal }) => getApiInventoryPutawaySuggestionsOrderId(orderId, requestOptions, signal);





   return  { queryKey, queryFn, enabled: orderId !== null && orderId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetApiInventoryPutawaySuggestionsOrderIdQueryResult = NonNullable<Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>>
export type GetApiInventoryPutawaySuggestionsOrderIdQueryError = unknown


export function useGetApiInventoryPutawaySuggestionsOrderId<TData = Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>, TError = unknown>(
 orderId: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>,
          TError,
          Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>
        > , 'initialData'
      >, request?: SecondParameter<typeof customInstance>}
...
export function useGetApiInventoryPutawaySuggestionsOrderId<TData = Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>, TError = unknown>(
 orderId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiInventoryPutawaySuggestionsOrderId<TData = Awaited<ReturnType<typeof getApiInventoryPutawaySuggestionsOrderId>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getGetApiInventoryPutawaySuggestionsOrderIdQueryOptions(orderId,options)
