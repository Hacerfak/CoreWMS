...
public record PendingReviewItemDto(
    ...
    string RawNcm,
    string? RawCest,    // <-- Adicionado
    string RawUnit,    // <-- Adicionado
...
public record InboundOrderDto(Guid Id, Guid? CustomerId, string? CustomerName, string IssuerCnpj, string IssuerName, string AccessKey, DateTime IssueDate, string Status, bool HasPendingReview);
